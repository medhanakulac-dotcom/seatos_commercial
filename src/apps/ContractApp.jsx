...
export default function App(){
  ...
  if(showSettings){
    ...
    <div style={ui.app}>
      ...
      <div style={{display:"flex",gap:12,marginBottom:12}}>
        <button style={{...ui.btn,background:CI.orange,color:"#fff",flex:1,opacity:saving?0.6:1}} onClick={handleSave} disabled={saving}>{saving?"Saving...":"💾 Save to Database"}</button>
        <button style={{...ui.btn,background:"#E91E8C",color:"#fff",flex:1}} onClick={()=>{setPricing(JSON.parse(JSON.stringify(DEF_PRICING)));setCompany({...DEF_COMPANY})}}>Reset to Defaults</button>
      </div>
      {saveMsg&&<p style={{textAlign:"center",fontSize:14,fontWeight:700,color:saveMsg.includes("✅")?CI.green:"#e53935",marginBottom:12}}>{saveMsg}</p>}
    </div></div>
  )}
  ...
  if(view==="form"){return(
    ...
    <div className="r-wrap" style={ui.wrap}>
      ...
      {isBundle&&<div className="scard" style={ui.card}><div className="sct" style={ui.ct}><span>Bundle: 12GO</span></div>
        <div><label style={ui.lb}>12GO Entity</label><div style={{padding:"10px 14px",background:"#F5F0EB",borderRadius:14,fontSize:14,color:CI.dark,fontWeight:600}}>{form.country==="Thailand"?"12Go (Thailand) Co., Ltd.":"12Go Asia PTE. LTD."}</div></div>
      </div>}
      ...
      <div style={{textAlign:"center",marginTop:32}}>
        <button className="scta" style={{...ui.btn,background:CI.orange,color:"#fff",padding:"14px 48px",borderRadius:10,fontSize:15}} onClick={()=>setView("preview")}>Preview Contract →</button>
      </div>
    </div></div>
  )}
...
{/* AGREEMENT — 3 pages, content packed to fill A4 */}
<div className="a4" style={pg.page}><Lg w={150}/><div style={pg.hr}/>
<div style={{...pg.title,fontSize:14,margin:"16px 0 10px"}}>SOFTWARE SUBSCRIPTION &amp; SERVICES AGREEMENT</div>
<p style={{fontSize:9,marginBottom:6,textAlign:"justify"}}>This Software Subscription and Services Agreement (collectively with any documents incorporated by reference, the "<b>Agreement</b>") is by and between <b>SeatOS</b>, operated by Bookaway Ltd., a company incorporated under the laws of the state of Israel ("<b>Company</b>") and the entity identified in the applicable Order ("<b>Customer</b>"). (Each a "<b>party</b>" and collectively, the "<b>parties</b>").</p>
...
<div style={pg.secTitle}>1. Subscription and Services</div>
<p style={{fontSize:9,marginBottom:4,textAlign:"justify"}}>1.1. Subject to the terms of this Agreement, Customer may use or receive the Company's software (and services that Customer selects in order forms (each an "Order") executed by both parties or, if available, entered into by Customer on-line through Company's website. "Subscription" means Customer's and its Permitted Users' access and usage rights to the Licensed Software (defined below) by and on behalf of Company, which shall include Support as set forth in the applicable Order. "Services" means those services or trainings that are agreed upon and set forth in the applicable Order. For purposes of this Agreement, "Permitted User" means Customer's employees, agents and contractors authorized by Customer to access and use the Licensed Software.</p>
<p style={{fontSize:9,marginBottom:4,textAlign:"justify"}}>1.2. "Licensed Software" means Company proprietary software as set forth in the Order, as well as the Documentation and other materials which may be furnished to Customer by Company in printed or electronic format that are pertinent to the use of the Subscription. "Documentation" means the manuals, specifications, and other materials describing the functionality, features, and operating characteristics of the Licensed Software that Company makes available to the Customer, as well as any updates thereto.</p>
<p style={{fontSize:9,marginBottom:4,textAlign:"justify"}}>1.3. License Grant. Subject to Customer's payment of Subscription Fees and its compliance with all the terms and conditions of this Agreement, Company hereby grants Customer a non-exclusive, non-sublicensable, and non-transferable limited license during the Subscription Term to: (i) use the Licensed Software as hosted by Company solely for Customer's internal business purposes; and (ii) use and make a reasonable number of copies of the Documentation solely for Customer's internal business purposes in connection with Customer's use of the Licensed Software. Customer right to access and use the Licensed Software is limited to the number of licenses purchased by Customer in accordance with the Order. Customer acknowledges and agrees that any act or omission of its Permitted Users hereunder which act or omission would constitute a breach of this Agreement if undertaken by Customer, shall be considered a material breach by Customer hereunder.</p>
<p style={{fontSize:9,marginBottom:4,textAlign:"justify"}}>1.4. Use Restrictions. Customer shall not use the Licensed Software or Documentation for any purposes beyond the scope of the license granted in this Agreement. Without limiting the foregoing and except as otherwise expressly set forth in this Agreement, Customer shall not at any time, directly or indirectly: (i) copy, reproduce, modify, or create derivative works of the Licensed Software or the Documentation, in whole or in part; (ii) rent, lease, lend, sell, sublicense, assign, distribute, publish, transfer, or otherwise make available the Licensed Software or the Documentation; (iii) reverse engineer, disassemble, decompile, decode, adapt, or otherwise attempt to derive or gain access to the source code of the Licensed Software, in whole or in part; (iv) remove any proprietary notices from the Licensed Software or the Documentation; or (v) use the Licensed Software in any manner or for any purpose that infringes, misappropriates, or otherwise violates any intellectual property right or other right of any person, or that violates any applicable law.</p>
<p style={{fontSize:9,marginBottom:4,textAlign:"justify"}}>1.5. Reservation of Rights. Company reserves all rights not expressly granted to Customer in this Agreement. Except for the limited rights and licenses expressly granted under this Agreement, nothing in this Agreement grants, by implication, waiver, estoppel, or otherwise, to Customer or any third party any intellectual property rights or other right, title, or interest in or to the Licensed Software.</p>
<p style={{fontSize:9,marginBottom:4,textAlign:"justify"}}>1.6. Delivery and Setup. Company shall, by itself or by any of its affiliates or subsidiaries, deliver the Licensed Software electronically, or by other means, in Company's sole discretion, to Customer following the Effective Date, upon implementation, setup and configuration of the Licensed Software for Customer's use ("Setup Services"). Customer agrees to provide Company reasonable access to its systems and network(s) for such Setup Services.</p>
<p style={{fontSize:9,marginBottom:4,textAlign:"justify"}}>1.7. Support and Maintenance. Company, by itself or by any of its affiliates or subsidiaries, shall provide Customer with standard technical support and maintenance services ("Support") at no additional charge, unless otherwise set forth in the Order, it being acknowledged and agreed that the Subscription Fees include full consideration for such Support. Customer agrees that such Support service includes the ongoing monitoring by Company of the Licensed Software performance and control of data quality. Customer will (a) allow Company reasonable remote access to Customer's Subscription for the purposes of resolving reported problems and/or to verify performance of the Licensed Software; (b) channel its communications regarding support of the Licensed Software, its Subscription account, and/or Services through its Permitted Users; and (c) provide Customer-specific information necessary for providing the Subscription and/or Services upon Company's request.</p>
<div style={pg.secTitle}>2. Obligations of the Parties</div>
